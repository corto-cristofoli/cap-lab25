...
if 'FILTER' in os.environ:
    abs_filter = os.path.join(HERE, os.environ['FILTER'])
    FILTER_FILES = glob.glob(abs_filter, recursive=True)
    print(f"Files filter (full path): {abs_filter} ({len(FILTER_FILES)} files found).")
