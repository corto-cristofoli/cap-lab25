...
class LinearCode:
    ...
    :py:meth:`add_statement` is repeatedly called in the codegen visitor
    ...
    def add_statement(self, i: CodeStatement) -> None:
        """
    ...
    def add_instruction_PRINTLN_INT(self, reg: DataLocation) -> None:
        ...
        self.add_statement(mv(A0, reg))
        self.add_statement(call(Function('println_int')))
